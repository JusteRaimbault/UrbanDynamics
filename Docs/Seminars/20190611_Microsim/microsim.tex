...
\justify
 ...
 \begin{itemize}
 \item Extended/rewrote a bibliographic data collection and management library (java) to get citation data from google scholar (parallel collection, mongodb storage)
...
\includegraphics[width=\textwidth,trim=3cm 0cm 0 cm 0cm]{figures/core_hdepth3_filtered_LOWRES.png}
...
\sframe{General purpose of SPENSER}{
  ...
  Individual and household-level spatially explicit simulation of population (projective model)

  $\rightarrow$ purpose: test policies and scenarios at any level
  ...
  \textit{In practice, not yet integrated}
