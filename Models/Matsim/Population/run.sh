...
if [ "$PARALLEL" = true ] ; then
    ...
    sbt "project spatialdata; runMain org.openmole.spatialdata.application.matsim.RunMatsim --synthpop --popMode="$POPMODE" --jobMode="$JOBMODE" --planMode=default --sample="$SAMPLE" --FUAName=\""$FUANAME"\" --FUAFile=/data/inputs/GHSFUAS/GHS_FUA_UCDB2015_GLOBE_R2019A_54009_1K_V1_0_WGS84.gpkg --LAFile=/data/inputs/LADistricts/LAD_WGS84.shp --OAFile=/data/inputs/OA/OA2011_WGS84.shp --MSOAFile=/data/inputs/MSOA/EnglandWalesScotland_MSOAWGS84.shp --SPENSERDirs=/data/inputs/SPENSER/England,/data/inputs/SPENSER/Scotland,/data/inputs/SPENSER/Wales --OSMBuildingsDirs=/data/inputs/OSMBuildings/England,/data/inputs/OSMBuildings/Scotland,/data/inputs/OSMBuildings/Wales --QUANTDataDir=/data/inputs/QUANT --output=/data/outputs/Plans"
fi
